  ...
  for (i = 0; i < news.length; i++) {
    ...
    if(i < 5) {
      if(i == 0) {
        ...
        twitter.rowSpan = '5';
        twitter.innerHTML = "<a class='twitter-timeline' data-height='440' data-width='100%' data-link-color='#2B7BB9' data-chrome='noheader nofooter noborders' href='https://twitter.com/englishse?ref_src=twsrc%5Etfw'></a>";
